...
namespace CommunicationFeatureProvider
{
    ...
    public class FeatureHub : Hub
    {
        ...
        {
            _activeDeviceService.AddActiveDevice(Context.UserIdentifier);
            return base.OnConnectedAsync();
        }

        public override Task OnDisconnectedAsync(Exception exception)
        {
            _activeDeviceService.RemoveActiveDevice(Context.UserIdentifier);
            return base.OnDisconnectedAsync(exception);
        }

        private readonly ILogger<FeatureHub> _logger;
        private readonly IFeatureEntityService _featureEntityService;
        private readonly IActiveDeviceService _activeDeviceService;

        public FeatureHub(ILoggerFactory loggerFactory, IFeatureEntityService featureEntityService, IActiveDeviceService activeDeviceService)
        {
            _logger = loggerFactory.CreateLogger<FeatureHub>();
            _featureEntityService = featureEntityService;
