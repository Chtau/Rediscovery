    ...
    public sealed class DeviceManager
    {
        ...
        public void Init()
        {
            try
            {
                ...
                Save(OnCreateMockDevice(new Guid("7AE08E8C-2C74-462C-950F-9EF82022A7B3"), "Device1", 1, new Guid("E4E7802E-07D1-4D99-A93C-04C4085F6B5E"), new Guid("C24FACAE-9368-4035-B5B3-5DB28C4A75B1"), new Guid("F24CA915-4297-4A22-AFBD-F4C4992E7FFF"), new Guid("279DD3C2-5E90-4A44-9569-15B719CC0867"), new Guid("6D15B5C4-4DB3-4B14-AD38-5EF0076F670A")));
                Save(OnCreateMockDevice(new Guid("E6BAAEB3-D92F-4FC1-85FE-92C4ED0F6644"), "Device2", 2, new Guid("5207AA48-99D5-43EA-9E60-439129A8328B"), new Guid("DE2A47C7-62C2-455F-B215-3D039FFB58BC"), new Guid("BC846F35-28BA-4B66-8A55-B187405BC312")));
                ...
                Save(devFav);
                Save(OnCreateMockDevice(new Guid("8E26DEEE-1691-43A5-8752-F641D0AACCA0"), "Device4", 4, new Guid("85A450C4-DE90-420D-944B-A0E667FAD3C4"), new Guid("867BAB40-61A3-403B-BDFF-A3F958967BC4"), new Guid("DAA3E66F-2900-4B39-BC99-BB6F67CC9E67"), new Guid("D1706F5F-1A3C-49B4-8698-A954F9853F92")));
            }
            catch (Exception ex)
            {
        ...
        public void Save(Features.Models.Device device)
        {
            try
            {
                if (device != null)
                {
                    ...
                    } else
                    {
                        if (device.OrderBy <= 0)
                        {
                            var maxOrder = Core.Database.Instance.GetAll<Features.Models.Device>()?.Max(x => x.OrderBy);
                            if (maxOrder > 0)
                                device.OrderBy = maxOrder.Value;
                        }
