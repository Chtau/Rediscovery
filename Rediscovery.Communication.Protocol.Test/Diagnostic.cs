...
namespace Rediscovery.Communication.Protocol.Test
{
    public class Diagnostic
    {
        ...
        public void Traffic()
        {
            ...
            Assert.True(protocol1.Traffic.IncomingPackageParts > 150, "Incoming should have received 173 package parts");
            Assert.True(protocol.Traffic.OutgoingPackageParts > 150, "Outgoing should have send 173 package parts");
        ...
        public void TrafficSize()
        {
            ...
            Assert.True(data == content, "No Data received via Socket");
            System.Threading.Thread.Sleep(TimeSpan.FromSeconds(1));
            Assert.True(protocol1.Traffic.IncomingDataBytes > 165000, "Incoming should have received 176256 raw bytes");
            Assert.True(protocol.Traffic.OutgoingDataBytes > 165000, "Outgoing should have send 176257 raw bytes");
        ...
        public void Timing()
        {
            ...
            Assert.True(protocol1.Timings[0].Times.Count > 150, "Incoming should have received 173 timings entries for 1 device");
